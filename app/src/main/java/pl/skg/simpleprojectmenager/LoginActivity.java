package pl.skg.simpleprojectmenager;
...
import pl.skg.simpleprojectmenager.admin.AdminStartActivity;
import pl.skg.simpleprojectmenager.model.User;
import pl.skg.simpleprojectmenager.user.UserStartActivity;
...
//        startActivity(new Intent(LoginActivity.this, NewUserActivity_POLIGON.class));
    ...
    private void initLoginValidation(User value, String loginData, String passwordData) {
        if (loginData.isEmpty()) {
            loginLabel.setError(getResources().getString(R.string.required_field));
        } else if (loginData.equals("aaa") && value == null) {
            loginLabel.setError(getResources().getString(R.string.no_user));
            buildAdminAccount();
...
//            Toast.makeText(this, "user dodany", Toast.LENGTH_LONG).show();
            ...
            loginLabel.setError(getResources().getString(R.string.not_found_user));
...
//                    startActivity(new Intent(LoginActivity.this, NewStepFormatAdapter.class));
                ...
                passwordLabel.setError(getResources().getString(R.string.wrong_password));
            }
        } else {
            loginLabel.setError(getResources().getString(R.string.not_found_user));
        }
